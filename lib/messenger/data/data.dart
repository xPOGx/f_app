...
final _email_3 = Email(
    ...
    attachments: [
      const Attachment(url: 'lib/messenger/assets/thumbnail_1.png')
    ]);

final _email_4 = Email(
  sender: _user_4,
  recipients: [],
...
class MessengerDb {
  final currentUser = _user_0;

  final users = [_user_1, _user_2, _user_3, _user_4];
  final emails = [_email_1, _email_2, _email_3, _email_4];
  final replies = [_replie_1, _replie_2];
}
